...
vcs -lca -timescale=1ps/1ps -sverilog +verilog2001ext+.v -ntb_opts dtm $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS \
  ...
  $QSYS_SIMDIR/submodules/sys_mm_interconnect_1_rsp_demux_002.sv \
  $QSYS_SIMDIR/submodules/sys_mm_interconnect_1_rsp_demux.sv \
  $QSYS_SIMDIR/submodules/sys_mm_interconnect_1_cmd_mux_002.sv \
  ...
  $QSYS_SIMDIR/submodules/sys_mm_interconnect_1_router_005.sv \
  $QSYS_SIMDIR/submodules/sys_mm_interconnect_1_router_004.sv \
  ...
  $QSYS_SIMDIR/submodules/sys_pio_0.v \
